"""
Django settings for rentarg project.
...
TEMPLATES = [
    {
        ...
        #'DIRS': [],
       # 'DIRS': [os.path.join(BASE_DIR, '../rentarg-front/templates')],
...
WSGI_APPLICATION = 'rentarg.wsgi.application'
...
""" DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ.get('MYSQL_DATABASE', 'rosariorent'),
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgresql://rosariorent_db_user:OqvHrvZ6cQ3d19VIQr6zd9IqDZLvYuH1@dpg-d490muu3jp1c73cr1fn0-a.oregon-postgres.render.com/rosariorent_db",
        conn_max_age=600,
        ssl_require=True
    )
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'tomidiazmoreno@gmail.com'
